...
const sidebar = ({ darkMode, toggleDarkMode }) => {
  return (
    <div>
      ...
      <div className="flex gap-3 items-center justify-center lg:pt-5 w-full lg:hidden md:hidden">
      ...
      <aside
        ...
        aria-label="Sidebar"
      >
        <div className="h-full px-3 py-4 overflow-y-auto bg-gray-50 dark:bg-[#1C1D22]">
